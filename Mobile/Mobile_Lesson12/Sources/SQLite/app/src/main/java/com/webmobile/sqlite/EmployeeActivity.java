...
import com.webmobile.sqlite.databinding.ActivityEmployeeBinding;
...
public class EmployeeActivity extends AppCompatActivity {
    ...
    public void updateToDB(View view) {
        ...
        String employeeQuery = SampleDBContract.Employee.COLUMN_FIRSTNAME + "=? AND " +
        ...
        database.update(SampleDBContract.Employee.TABLE_NAME, values, employeeQuery, employeeArgs);
    }
    ...
    public void deleteFromDB(View view) {
        ...
        database.delete(SampleDBContract.Employee.TABLE_NAME, employeeQuery, employeeArgs);
    }
}